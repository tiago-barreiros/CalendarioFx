...
> As interfaces gráficas mais recentes são dotadas de um leque de características estéticas ricas e bem
cuidadas, tornando assim a interface mais apelativa para o utilizador.

> A aplicação permite escolher um ano e um mês, apresentando o calendário desse mês. Como se pode ver, existe um GridPane (7x7) para estruturar os dias
do calendário. Os quadrados brancos e azuis são simplesmente componentes Label. A aplicação permite
marcar dias (amarelo), através do rato.
...
Após a entrega deste projeto ficará publico :  https://github.com/tiago-barreiros/CalendarioFx
